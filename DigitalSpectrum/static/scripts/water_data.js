...
d3.csv("static/data/sensorData.csv", function(data){
    ...
    data.forEach(function(d) {
      ...
      d.waterTemp = parseFloat(d.waterTemp);
    });
  ...
  var data = d3.nest()
      ...
      var yScale = d3.scaleLinear()
        .domain([50,
                d3.max(data, function(d) { return d.waterTemp})])
        .range([ height, 0 ]);
    ...
    var xScale = d3.scaleLinear()
     ...
     var area = d3.area()
  	     ...
  	     .y0(height)
  	     .y1(function(d) { return yScale(d.waterTemp); });
  	...
  	// LEFT CHART
  	var svg = d3.select("#chart-waterTemp").append("svg")
